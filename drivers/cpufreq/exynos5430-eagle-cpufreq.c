...
static void __init set_volt_table_CA15(void)
{
	...
	//pr_info("CPUFREQ of CA15 max_freq : L%d %u khz\n", max_support_idx_CA15, exynos5430_freq_table_CA15[max_support_idx_CA15].frequency);
	//pr_info("CPUFREQ of CA15 min_freq : L%d %u khz\n", min_support_idx_CA15, exynos5430_freq_table_CA15[min_support_idx_CA15].frequency);
#else
